...
DESCRIPTION="List of packages that are needed inside the ChromiumOS base (release)"
...
RDEPEND="
	...
	dlc? (
		...
		chromeos-base/ext2-dlc
		chromeos-base/ext4-dlc
		chromeos-base/sample-dlc
		chromeos-base/sample-lvm-dlc
		chromeos-base/prebuilt-sample-dlc
		chromeos-base/scaled-dlc
		chromeos-base/user-tied-dlc
		chromeos-languagepacks/tts-bn-bd-c
		chromeos-languagepacks/tts-cs-cz-c
		chromeos-languagepacks/tts-da-dk-c
		chromeos-languagepacks/tts-de-de-c
		chromeos-languagepacks/tts-el-gr-c
		chromeos-languagepacks/tts-en-au-c
		chromeos-languagepacks/tts-en-gb-c
		chromeos-languagepacks/tts-en-us-c
		chromeos-languagepacks/tts-en-us-d
		chromeos-languagepacks/tts-es-es-c
		chromeos-languagepacks/tts-es-us-c
		chromeos-languagepacks/tts-fi-fi-c
		chromeos-languagepacks/tts-fil-ph-c
		chromeos-languagepacks/tts-fr-fr-c
		chromeos-languagepacks/tts-hi-in-c
		chromeos-languagepacks/tts-hu-hu-c
		chromeos-languagepacks/tts-id-id-c
		chromeos-languagepacks/tts-it-it-c
		chromeos-languagepacks/tts-ja-jp-c
		chromeos-languagepacks/tts-km-kh-c
		chromeos-languagepacks/tts-ko-kr-c
		chromeos-languagepacks/tts-nb-no-c
		chromeos-languagepacks/tts-ne-np-c
		chromeos-languagepacks/tts-nl-nl-c
		chromeos-languagepacks/tts-pl-pl-c
		chromeos-languagepacks/tts-pt-br-c
		chromeos-languagepacks/tts-pt-pt-c
		chromeos-languagepacks/tts-si-lk-c
		chromeos-languagepacks/tts-sk-sk-c
		chromeos-languagepacks/tts-sv-se-c
		chromeos-languagepacks/tts-th-th-c
		chromeos-languagepacks/tts-tr-tr-c
		chromeos-languagepacks/tts-uk-ua-c
		chromeos-languagepacks/tts-vi-vn-c
		chromeos-languagepacks/tts-yue-hk-c
		!ferrochrome? (
			app-accessibility/facegaze-assets
			app-accessibility/pumpkin
			app-accessibility/screen-ai
			chromeos-languagepacks/extrafonts-ja
			chromeos-languagepacks/extrafonts-ko
			...
			chromeos-languagepacks/handwriting-en
	...
	floss? (
		!asan? (
			!ubsan? (
				!floss_upstream? ( net-wireless/floss )
				floss_upstream? ( net-wireless/floss-upstream )
				flex_bluetooth? ( chromeos-base/flex_bluetooth )
			)
		)
	)
	uwb? ( net-wireless/uwbd )
	...
	fbpreprocessord? ( chromeos-base/fbpreprocessord )
	...
	kvm_host? (
		...
		chromeos-base/vhost_user_starter
	)
	...
	!dev-python/socksipy
	arc-camera3? (
		camera_diagnostics? ( chromeos-base/cros-camera-diagnostics )
	...
	heartd? ( chromeos-base/heartd )
	vkms? ( chromeos-base/chromeos-gce-l1-vkms )
	sturgeon? ( chromeos-base/sturgeon )
"
...
# Clean up arc files for WhaleOS
CROS_RDEPEND="${CROS_RDEPEND}
	chromeos-base/extended-updates-arc-cleanup
"
...
# WHALEOS_BUILD: the ime? asset packages (app-i18n/chinese-input,
# keyboard-input, hangul-input and the NAVER-added japanese-input) are no
# longer pulled - replaced by IME engines bundled in chrome.
